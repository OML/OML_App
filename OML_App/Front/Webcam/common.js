...
function openRemote() 
{
	popupWindow = window.open("/remote.html",'popUpWindow','height=520,width=640,toolbar=no,menubar=no,location=no,directories=no,status=no');
}
...
function loadFeed() {
  ...
  working.attr("src","http://192.168.1.102:8090/webcam.mjpeg?rnd="+Math.floor(Math.random()*1000000));
}
